...
const DEFAULT_CONFIG = Object.freeze({
    ...
    publicMembershipCopy: CONTINUITY_PUBLIC_COPY,
...
function validateConfig(input) {
    const config = {
        ...
        showPrivateJournal: Boolean(input.showPrivateJournal),
        publicMembershipCopy: normalizeLegacyPublicMembershipCopy(input.publicMembershipCopy),
...
function createBusinessConfigStore({ dataDir, now = () => new Date(), auditLog } = {}) {
    ...
    async function getPublic() {
        ...
        return {
            ...
            showPrivateJournal: config.showPrivateJournal,
